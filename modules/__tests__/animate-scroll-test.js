...
describe("AnimateScroll", () => {
  ...
  let wideComponent = (
    <div id="wideComponent">
      <a onClick={() => animateScroll.scrollToTop({ horizontal: true })}>
        Scroll To Top!
      </a>
      <a onClick={() => animateScroll.scrollTo(100, { horizontal: true })}>
        Scroll To 100!
      </a>
      <a onClick={() => animateScroll.scrollMore(10, { horizontal: true })}>
        Scroll More!
      </a>
      <div
  ...
  it("scrolls to a position given a node as a container vertically", (done) => {
    render(tallComponent, node, () => {
      window.scrollTo(0, 0);
      node.style.cssText =
        "position: fixed; top: 0; bottom: 200px; width 100%; overflow: scroll";
  ...
  it("scrolls to a position given a node as a container horizontally", (done) => {
    renderHorizontal(wideComponent, node, () => {
      window.scrollTo(0, 0);
      node.style.cssText =
        "position: fixed; left: 0; right: 200px; height 100%; overflow: scroll";
  ...
  it("scrolls to bottom", (done) => {
    render(tallComponent, node, () => {
      ...
      setTimeout(() => {
        expect(window.scrollY || window.pageYOffset).toEqual(
  ...
  it("scrolls to bottom horizontally", (done) => {
    renderHorizontal(wideComponent, node, () => {
      ...
      setTimeout(() => {
        expect(window.scrollX || window.pageXOffset).toEqual(
